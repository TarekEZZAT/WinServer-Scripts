...
New-NetIPAddress $address -InterfaceIndex $IfIndex -DefaultGateway $DefaultGateway
}
...
#add-computer -computername (get-content servers.txt) -domainname ad.contoso.com –credential AD\adminuser -restart –force
